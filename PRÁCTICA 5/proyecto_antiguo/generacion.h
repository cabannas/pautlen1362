...
void igual(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void distinto(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void menorigual(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void mayorigual(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void menor(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void mayor(FILE * fpasm, int etiqueta, int es_direccion_1, int es_direccion_2);

void control_errores_vector(FILE * fpasm, char * id, int es_direccion, int tam);
